...
int detect(char *model_path, char *image_path, char *save_image_path)
{
    ...
    printf("model once run use %f ms\n", (__get_us(stop_time) - __get_us(start_time)) / 1000 / temp);
    ...
    GetResultRectyolov11 PostProcess;
...
{
    char model_path[256] = "/home/firefly/zhangqian/rknn/rknpu2_1.4.0/examples/rknn_yolov13_demo_dfl_open/model/RK3588/yolov13n_80class_ZQ_smi.rknn";
    char image_path[256] = "/home/firefly/zhangqian/rknn/rknpu2_1.4.0/examples/rknn_yolov13_demo_dfl_open/test.jpg";
    char save_image_path[256] = "/home/firefly/zhangqian/rknn/rknpu2_1.4.0/examples/rknn_yolov13_demo_dfl_open/test_result.jpg";
